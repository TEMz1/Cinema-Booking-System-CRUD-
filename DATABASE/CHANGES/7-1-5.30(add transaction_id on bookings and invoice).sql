...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2025 at 05:34 AM
...
INSERT INTO `bookings` (`bookid`, `session_id`, `custid`, `hallNo`, `seatNo`, `transaction_id`) VALUES
(597, 41, 5, 'HALL-1                            ', 'A2', 'TRANS_677bb616d7b845.97723830');
...
INSERT INTO `invoice` (`invoiceno`, `price`, `custid`, `theaterName`, `hallNo`, `date`, `showtime`, `chosenSeat`, `transaction_id`) VALUES
(42, 20, 5, 'Paragon Cinema - KTCC Mall', 'HALL-1                            ', '06 Jan 2025', '20:00 pm', 'A2', 'TRANS_677bb616d7b845.97723830');
...
(40, 'HALL-2', 10, '2025-01-09 00:00:00', '2025-01-09 15:00:00'),
(41, 'HALL-1', 10, '2025-01-08 20:00:00', '2025-01-08 23:00:00'),
(42, 'HALL-1', 10, '2025-01-07 02:30:00', '2025-01-07 11:30:00');
...
--
ALTER TABLE `bookings`
  MODIFY `bookid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=598;
...
--
ALTER TABLE `invoice`
  MODIFY `invoiceno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
