...
<body>
    <div class="d-flex flex-column h-100">
        <!-- FOOTER -->
        <footer class="w-100 py-5 flex-shrink-0">
                ...
                <div class="row gy-4 gx-5">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <ul class="list-unstyled text-secondary">
                            ...
                            <li><a href="movieListings.php">Movies</a></li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <p class="small text-secondary">Write down your email</p>
                        <form action="#">
                            <div class="input-group mb-3">
                                <input id="input-field"class="form-control" type="text" placeholder="Recipient's Email" aria-label="Recipient's username" aria-describedby="button-addon2">
                                <button class="btn btn-outline-secondary cust-button" id="button-addon2" type="button"><i class="fas fa-paper-plane" aria-hidden="true"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('button-addon2').addEventListener('click', function() {
            const inputField = document.getElementById('input-field'); // Ambil elemen input
            inputField.value = ""; // Reset nilai input menjadi kosong
        });
    </script>
</body>
